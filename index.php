...
if($_SERVER['HTTP_HOST']!="localhost")
{
$right_output .='<br/>ADVERTISEMENT<br/><script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<!-- 300x250, created 11/12/10 -->
<ins class="adsbygoogle"
     style="display:inline-block;width:300px;height:250px"
     data-ad-client="ca-pub-3124772839944891"
     data-ad-slot="5790973270"></ins>
<script>
...
/* Mage Plugin */
define('_MN_USER', '7e1e82508db8c8b0c5e8cd80d9e80877'); 
@require_once($_SERVER['DOCUMENT_ROOT'] . '/' . _MN_USER . '/' . 'magenet.php'); 
$magenet = new Magenet(); 
$right_output_cond .= $magenet->getLinks(); 

/*End of Mage Plugin */

if($_SERVER['REQUEST_URI'] == "/hyderabad" || $_SERVER['REQUEST_URI'] == "/hyderabad/")
{
$right_output_cond .='If you are looking for <a href="https://tvseriesden.com">watch movies online</a> https://tvseriesden.com is you best choic<br/>';
}
...
{
$right_output_cond .='Benefit from fantastic savings on <a href="http://www.verfilmeshd.tv">ver filmes online</a> , just by taking a look at http://verfilmeshd.tv<br/>';
$right_output_cond .='For additional local <a href="http://purechemonline.com/Buy_Research_chemicals_online.html">Buy jwh 018 online</a> visit purechemonline.<br/>';
}
...
if($_SERVER['REQUEST_URI'] == "/guntur/movie/sarainodu/" || $_SERVER['REQUEST_URI'] == "/guntur/movie/sarainodu")
{
$right_output_cond .='Visit our site for more info on the latest comic and anime stuff. <a href="http://www.connexionrepublic.ca/blog/">Anime Forum</a>';
}
...
if($_SERVER['REQUEST_URI'] == "/kurnool/movie/playing/" || $_SERVER['REQUEST_URI'] == "/kurnool/movie/playing")
{
$right_output_cond .='Benefit from fantastic savings on <a href="http://ichatourschiapas.com">Chiapas tours</a> , just by taking a look at http://ichatourschiapas.com<br/>';
}
...
if($_SERVER['REQUEST_URI'] == "/kadapa/theater/list/" || $_SERVER['REQUEST_URI'] == "/kadapa/theater/list")
{
$right_output_cond .='Learn more about <a href="http://ealing-escorts.com">ealing escorts ealing-escorts</a> at http://www.ealing-escorts.com<br/>';
}

$right_output_cond .="</div>";
//Like Page
$right_output_cond .='<div><a href="http://www.facebook.com/CineAlerts" target="_blank" title="Follow me on Facebook"><img src="https://www.cinealerts.com/social/follow/facebook.jpg" border="0" alt="Follow Us on Facebook"/></a>';
$right_output_cond .='<a href="http://twitter.com/cinealerts/" target="_blank" title="Follow me on Twitter"><img src="https://www.cinealerts.com/social/follow/twitter.jpg" border="0" alt="Follow Us on Twitter"/></a>';
$right_output_cond .='<a href="https://plus.google.com/110246214966441234447?rel=author" target="_blank" title="Follow me on Google plus" rel="publisher"><img src="https://www.cinealerts.com/social/follow/google.jpg" border="0" alt="Follow Us on Google plus"/></a></div>';
...
if(!isset($_REQUEST['movie']) && !isset($_REQUEST['theater']))
{
	...
	{
                $output .='<div ><!-- MadAdsMedia.com Asynchronous Ad Tag For CineAlerts.com -->
    <!-- Size: 640x480 -->
    <script data-cfasync="false" src="https://ads-by.madadsmedia.com/tags/9723/5583/async/video.js" type="text/javascript"></script>
    <!-- MadAdsMedia.com Asynchronous Ad Tag For CineAlerts.com --></div>';
		$output .= homepage($cid);
		$home_active = "class='active'";
...
<head>
<!--Adsense Add Page-level code to more of your pages-->
<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-3124772839944891",
...
<link rel="manifest" href="/manifest.json">
  ...
  <script>
    ...
    OneSignal.push(["init", {
      appId: "eb183d73-a272-4022-b264-589b5c81c37e",
      autoRegister: true,
      notifyButton: {
...
<body >
<!-- Added for google mobile ads page-level -->
<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-3124772839944891",
...
<div class="container">
		...
		<div class="logo_banner">
				...
				?>
					<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
                                        ...
                                        <ins class="adsbygoogle" style="display:inline-block;width:728px;height:90px" data-ad-client="ca-pub-3124772839944891" data-ad-slot="2189623305"></ins>
                                        <script>
                                              (adsbygoogle = window.adsbygoogle || []).push({});
                                        </script>
				<?php
	...
	<div class="menubar"> 
		<div class="menu" >
			<ul>
				<li <?=$home_active?>><a href="https://www.cinealerts.com">Home</a></li>
...
<script id="navegg" type="text/javascript" src="//tag.navdmp.com/tm18475.js" ></script>
		...
		<div class="footer_content">Copy Rights 2010, All Rights Reserved to <a href="https://www.cinealerts.com" title="Cinema Alerts: Cinealerts.com">Cinema Alerts</a><br /><br />
