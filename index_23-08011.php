...
if(!isset($_REQUEST['movie']) && !isset($_REQUEST['theater']))
{
	if(isset($_REQUEST['task']))
	{
		...
		{
			case 'poll': $output .=poll_display(1, $cid);
						 $home_active = "class='active'";
						 break;
				...
				<td class="menu" width="390">
					<table width="100%" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td <?=$movies_active?> ><a href="<?=set_url("index.php?city=".$city."&movie=")?>">Movies</a><?=menucities($cid)?></td>
							
							<td <?=$theaters_active?> ><a href="<?=set_url("index.php?city=".$city."&theater=")?>">Theaters</a><?=menucities($cid,"theater")?></td>
...
<a href="http://www.orkut.co.in/Main#Profile.aspx?rl=mp&uid=5237007838423815938" title="Orkut" target="_blank"><img src="<?=set_url("social/share/orkut.png")?>" border="0" alt="Orkut" /></a>
...
<div><div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#appId=158606257541465&amp;xfbml=1"></script><fb:like href="http://www.cinealerts.com" send="false" layout="button_count" width="80" show_faces="false" font="arial"></fb:like></div>
...
<!-- COMPETE Tag-->
<script type="text/javascript">
__compete_code = '679209a1fd7222485d87d2d85c3f0cf1';
(function () {
    var s = document.createElement('script'),
        e = document.getElementsByTagName('script')[0];
    s.src = (document.location.protocol.toLowerCase() === 'https:' ? 'https:' : 'http:') +
        '//c.compete.com/bootstrap/679209a1fd7222485d87d2d85c3f0cf1/bootstrap.js';
