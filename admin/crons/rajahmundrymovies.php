...
$host2 = "localhost";
$dbname2 = "fullraj_cityinfo";
$dbuser2 = "fullraj_cityinf";
$dbpassword2 = "Krishna123";
update_rajahmundry_movies();

function update_rajahmundry_movies()
{
	global $host, $dbname, $dbuser, $dbpassword, $host2, $dbname2, $dbuser2, $dbpassword2;
	
	$db = mysql_connect($host,$dbuser,$dbpassword);
	mysql_select_db($dbname, $db);
	$theaters = mysql_query("select * from theaters where cid = '7'");
	...
	{	
		...
		$moviedetails = get_movie_details($movie['mid'], 7);
		$playinglist = get_playing_theaters(7,$movie['mid']);
		$imageid = $movie['mid'].".jpg";
		$metakey = $movie_name.",movie, rajahmundry, playing, movies, theaters, details";
		$metadesc = $movie_name." movie in rajahmundry playing theaters, User reviews and comments posted on ".$movie_name." movie. List of the theaters playing ".$movie_name;
		$metadata = $movie_name." movie in rajahmundry playing theaters, User reviews and comments posted on ".$movie_name." movie. List of the theaters playing ".$movie_name;
...
function get_movie_details($mid,$cid = 7)
{
	global $host, $dbname, $dbuser, $dbpassword, $host2, $dbname2, $dbuser2, $dbpassword2;
...
function get_playing_theaters($cid = 7,$mid)
{
	global $host, $dbname, $dbuser, $dbpassword, $host2, $dbname2, $dbuser2, $dbpassword2;
