...
$server               = "mail.cinealerts.com";                //    Set this to hard code the server name
...
$login                 = 'cinealer';
$pass                  = 'Krishna@2347';
$KeyUserID            = 'me';                                        //  for the db record to id the programas the user
...
function  message_details($MsgOne, $msgNo, $fp)
   ...
   */
           ...
           $TIRSFlag             = true;     // flag for seeing if the email is really to be processed by the app
...
$inc_sec_off            = substr(stristr($body[$x], ":"),1);   }
	...
	$vemail =  extractEmail($message_body);
        echo '<form action="http://www.cinealerts.com/unsubscribe.php" method="post" name="unsubform" target="_blank">
'.$vemail.'<input type="hidden" name="email" size="100" value='.$vemail.' />
...
if($vemail)
{
	...
	@mysql_query("insert into unsubsc(email) values('".addslashes($vemail)."')");
	$msg = "We have received your email address for unsubscription. Please allow us 7 days to remove from our list";
	
	@mysql_query("delete from kakinada_users where email = '".$vemail."'");

	@mysql_query("delete from hyderabad1 where email = '".$vemail."'");
	@mysql_query("delete from hyderabad2 where email = '".$vemail."'");
	@mysql_query("delete from hyderabad3 where email = '".$vemail."'");
	@mysql_query("delete from hyderabad4 where email = '".$vemail."'");
	@mysql_query("delete from hyderabad5 where email = '".$vemail."'");
	@mysql_query("delete from hyderabad6 where email = '".$vemail."'");
	@mysql_query("delete from hyderabad7 where email = '".$vemail."'");
	@mysql_query("delete from hyderabad8 where email = '".$vemail."'");
	@mysql_query("delete from hyderabad9 where email = '".$vemail."'");
	@mysql_query("delete from hyderabad10 where email = '".$vemail."'");
	@mysql_query("delete from hyderabad11 where email = '".$vemail."'");
	@mysql_query("delete from hyderabadusers where email = '".$vemail."'");
	echo "----deleted";
}
echo "</td></tr>";
