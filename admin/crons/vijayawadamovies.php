...
$host2 = "localhost";
$dbname2 = "vijayawa_world";
$dbuser2 = "vijayawa_world";
$dbpassword2 = "Krishna123";
update_vijayawada_movies();

function update_vijayawada_movies()
{
	global $host, $dbname, $dbuser, $dbpassword, $host2, $dbname2, $dbuser2, $dbpassword2;
	
	$db = mysql_connect($host,$dbuser,$dbpassword);
	mysql_select_db($dbname, $db);
	$theaters = mysql_query("select * from theaters where cid = '6'");
	...
	{	
		...
		$moviedetails = get_movie_details($movie['mid'], 6);
		$playinglist = get_playing_theaters(6,$movie['mid']);
		$imageid = $movie['mid'].".jpg";
		$metakey = $movie_name.",movie, Vijayawada, playing, movies, theaters, details";
		$metadesc = $movie_name." movie in Vijayawada playing theaters, User reviews and comments posted on ".$movie_name." movie. List of the theaters playing ".$movie_name;
		$metadata = $movie_name." movie in Vijayawada playing theaters, User reviews and comments posted on ".$movie_name." movie. List of the theaters playing ".$movie_name;
...
function get_movie_details($mid,$cid = 6)
{
	global $host, $dbname, $dbuser, $dbpassword, $host2, $dbname2, $dbuser2, $dbpassword2;
...
function get_playing_theaters($cid = 6,$mid)
{
	global $host, $dbname, $dbuser, $dbpassword, $host2, $dbname2, $dbuser2, $dbpassword2;
